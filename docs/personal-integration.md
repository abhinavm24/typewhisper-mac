...
A newer event cancels the superseded run. App tests, SDK tests and DMG packaging
run in parallel within each run. Inputs are checked again before publication;
